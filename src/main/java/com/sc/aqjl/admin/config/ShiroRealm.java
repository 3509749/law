package com.sc.aqjl.admin.config;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if (hasUser != null) {
            ...
            List<URole> rlist = roleService.getRolesByUserId(hasUser.getId());//获取用户角色
            List<UPermission> plist = roleService.listByUserId(hasUser.getId());//获取用户权限
